...
class GP(models.Model):
    ...
    track = models.ForeignKey(models.Track, null=False, on_delete=models.DO_NOTHING)
...
class Track(models.Model):
    ...
    location = models.ForeignKey(models.Location, null=False, on_delete=models.DO_NOTHING)
...
class Location(models.Model):
    ...
    state = models.ForeignKey(models.State, null=False, on_delete=models.DO_NOTHING)
...
class State(models.Model):
    # id = models.BigAutoField() <--- PRIMARY KEY
    acronym = models.CharField(min_length=2, max_length=2, null=False)
...
class QualRace(models.Model):
    # id = models.BigAutoField() <--- PRIMARY KEY
    gp = models.ForeignKey(models.GP, null=False, on_delete=models.CASCADE)
    driver = models.ForeignKey(models.Driver, null=False, on_delete=models.CASCADE)
    ...
    driverTeam = models.ForeignKey(models.Team, null=False, on_delete=models.CASCADE)
...
class Driver(models.Model):
    ...
    team = models.ForeignKey(models.Team, null=False, on_delete=models.CASCADE)
